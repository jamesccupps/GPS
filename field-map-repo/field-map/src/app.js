...
/* Maine GeoLibrary republishes the scanned USGS quads and every ortho flight the
   ...
   The three municipal flights are the sharpest imagery of the lot -- city flights
   are typically half-foot where NAIP is a metre -- and they name the town in
   their service paths. lock.py used to refuse to publish that; the road and town
   came off TELLTALES by decision, because the repository is public and names
   both anyway. */
const HIST=[
